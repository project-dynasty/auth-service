package com.projectdynasty.config;
...
public class JsonConfig {
    ...
    public void saveConfig() {
        ...
        try (final FileWriter writer = new FileWriter(this.file)) {
            writer.write(AuthService.GSON.toJson(this.object));
        } finally {
            return;
        }
    }
    ...
    public <T> T get(String key, Class<T> tClass) {
        ...
        return AuthService.GSON.fromJson(this.object.get(key), tClass);
    }
    ...
    public <T> T set(String key, T t) {
        this.object.add(key, AuthService.GSON.toJsonTree(t));
        return t;
    }
